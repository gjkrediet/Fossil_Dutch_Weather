...
![weather](https://github.com/gjkrediet/Fossil_Dutch_Weather/assets/20277013/afbbb891-aa12-48fb-a3ad-0227c9469bb9)
...
Three Tasker tasks are included for retreiving and storing weather information. The main part of each task is a java scriptlet. One task is for downloading and storing buienradar-data, one for downloading and storing KNMI-data and one for retreiving the current location and city. Import the tasks in Tasker, change them to your needs and create a profile for each to run them at a regular interval. KNMI-data needs an API-key which you can obtain at weerlive.nl (for free for a limited update frequency) and insert into the http-request in tasker. Same goes for the google reverse geocoding api to find the cityname of your location. Search for YOURKEY in the concerning http-requests in Tasker.
